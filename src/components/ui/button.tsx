  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-primary-foreground font-semibold shadow-gold hover:shadow-xl hover:scale-105 hover:glow-gold transition-bounce",
        "ghost-gold": "text-primary border border-primary/20 bg-transparent hover:bg-primary hover:text-primary-foreground hover:shadow-gold transition-smooth",
        minimal: "text-foreground hover:text-primary transition-smooth border-b border-transparent hover:border-primary"
      },
      size: {
